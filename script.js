...
const testArr = { ...h1.parentElement.children };
console.log(testArr);

const testArr2 = [...h1.parentElement.children];
...
/////////////////////////////////////////
// Reveal sections
const allSectsions = document.querySelectorAll('.section');
...
allSectsions.forEach(function (section) {
